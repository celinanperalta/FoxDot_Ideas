...
p3 >> ambi(2, dur=1, sus=0.3, amp=1) + (0, var.prog)

p4 >> pasha([2,PRand([3,4])], dur=var([1/2, PSum(3,2)]), amp=var([1,0], [PRand([6,8,12]),PRand([1,2,3])]), shape=0.2, formant=2, oct=var([4,5], 8)) + var.prog + PRand([-3, 1])
