...
p2 >> viola([3, 2, 1, 0], dur=PRand([4,8,16]), sus=12, amp=0.6, vib=0.05, room=0.8, blur=1, echo=1).every(6, "mirror") + var(PRand([0, 3, 5 ,7]), 8)

p3 >> snick(PRand(16), dur=2, coarse=16, lpr=0.2, amp=linvar([0.2,2], 8), chop=4)
