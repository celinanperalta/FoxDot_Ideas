...
d4 >> play("{gb}", dur=PRand([1/4, 1/2]), amp=0.75, rate=linvar([0,PRand(4)], PRand(8)))


for i in range(1, 5):
    p1 >> pasha(sinvar([-i,i],8), dur=var([Cycle([1/2,1])/2, 1], PRand([4,6,8])), fmod=4, formant=1, drive=linvar([0.05, 0.5], 4), shape=0.5)
