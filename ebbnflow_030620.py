...
p1 >> pasha(var([4, 7, 6, 5]), dur=var(PRand([1/2, 1/3, 1/4]), PRand([2,4,8])), room=0.2, mix=0.2, oct=4, drive=0.1, formant=linvar([1,4], 8), amp=var([1,0], [48, 32])).every(4, "shuffle") + var([0, 2, 2, 0])
